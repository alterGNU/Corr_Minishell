 ...
 */
t_list	*get_env_lst_node_form_key(t_list *env_lst, char *key)
{
	t_list	*act;
 ...
 * step2) create a dt from <char **ev>
...
int	main(int ac, char **av, char **ev)
{
	...
	t_token tab_raw_a1[]= {{AFF,"new_1=val_1",0},{AFF,"new2=",0},{0,0,0}};
	t_env tab_res_a1[]	= {{"old_1","a"},{"old2",""},{"new_1","val_1"},{"new2",""},{0,0}};
	nb_err += test(ev_a1, tab_raw_a1, tab_res_a1);
	print_sep(S2);
